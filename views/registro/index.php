...
<html lang="en">
    ...
    <main class="main">
        <section class="content"  id="content-main">
            <form  method="POST" action="<?php echo constant('URL'); ?>registro/solicitud" id="msform" enctype="multipart/form-data">
                <ul id="progressbar">
                ...
                <div class="form-content">
                    <!-- Titulo -->    
                    <a href="<?php echo constant('URL'); ?>" class="btn-back"><i class="fa-solid fa-left"></i></a>

                    <h4 class="fs-title text-center">Solicitud de alta</h2>
